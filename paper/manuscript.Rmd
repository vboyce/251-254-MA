...
TODO figure out how to fix the fact that some of the p-orig and predInt had things on different scales b/c I screwed up ! Whether to switch all the SMD or only the ones we can't get on original!!!

ALSO figure out how to talk about tau**2 and do that

TODO propogate naming schemes to supplement wrt models
