...
* There's been a lot of discussion aroun replicabilty and it's role and yadda yadda (much overfocused on RP:P results because that's what's available). Growing sophistication and valid points, but we think it misses the mark about what practicing scientists are concerned about. 
...
* gives clear interpretation -- no mention of truth (may even be reliable in a different environment, but would be)


* Previous work, especially RP:P has been overfit &
also include somewhere:
* pedagogy
* overfit to small sample 
*
