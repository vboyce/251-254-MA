...
Other replication projects have other estimands: @camerer2018 seems to ask something closer to how likely studies are to replicate when preformed by an expert with a large budget, and @ML5 TODOCITE asks how likely certain studies are to replicate when performed with extensive feedback from the original authors.  
