...
These replications were all conducted on short time scales, within a constrained class budget. In some cases the budget limited the number of participants who could be recruited, occasionally below what the original study included or what power analyses suggested. The replications had a median post-exclusion sample size that was `r round(ratio_dist[3]*100)`% of the original sample size.  In nearly all cases, replications were conducted online, with recruitment from Amazon Mechanical Turk (the default from 2011 to 2020) or Prolific (the default from 2021 -- 2022). 
         ...
         within_between=ifelse(within_between=="between", 0, 1)) %>% 
             tbl_summary(
               label=list(
                 ...
                 within_between ~ "Within subjects design",
...
dat <-  for_cor %>% mutate(cognitive=ifelse(subfield=="cognitive",1,0)) %>% select(-sub_rep, -subfield) 
...
melted_corr_mat <-melt(corr_mat) %>% 
  ...
  mutate(Var1=factor(Var1, levels=c("social", "cognitive", "other_psych", "non_psych", "is_within", "single_vignette", "stanford", "change_platform", "open_data", "open_mat", "pub_year", "log_trials", "log_sample", "log_ratio_ss"), labels=c("Social psych", "Cognitive psych", "Other psych", "Non-psych", "Within participants design", "Single vignette ","Stanford affiliated", "Switch to online", "Open data", "Open materials", "Publication year", "Log # of trials", "Log original sample size", "Log ratio rep/original sample sizes")),
         Var2=factor(Var2, levels=c("social", "cognitive", "other_psych", "non_psych", "is_within", "single_vignette", "stanford", "change_platform", "open_data", "open_mat", "pub_year", "log_trials", "log_sample", "log_ratio_ss"), labels=c("Social psych", "Cognitive psych", "Other psych", "Non-psych", "Within participants design", "Single vignette ","Stanford affiliated", "Switch to online", "Open data", "Open materials", "Publication year", "Log # of trials", "Log original sample size", "Log ratio rep/original sample sizes")))
...
# Methods
Our pre-registration, code, and coded data are available at https://osf.io/xwn9m/ [@osfdata]. <!--TODO VIEW ONLY https://osf.io/xwn9m/?view_only=ebb6df1ae97045cfa5154d6119ec20b1-->
