...
library(kableExtra)
knitr::kable(cors, digits = 3, align='rcc',format="latex", position="!h", caption="The correlation between each individual predictor and the subjective replication score. For subfield, cognitive psychology is treated as the baseline condition. See Methods for how these variables were coded.", booktabs=TRUE) |> kable_styling(full_width=F, font_size=10) 
...
Four of these replication projects were included in RP:P, and 10 of them were previously reported in @hawkins2018. 
