         ...
         within_between=ifelse(within_between=="between", 0, 1)) %>% 
             tbl_summary(
               label=list(
                 ...
                 single_vignette ~ "Single vignette",
                 open_data ~ "Open data",
...
```{r corr-plot, out.height="40%", fig.width=8, fig.height=4.5, fig.pos="ht", fig.cap="Correlations between predictors. See TODO Table 1 or Methods for descriptions. "}
