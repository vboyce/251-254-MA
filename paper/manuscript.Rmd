...
Researchers use the psychological literature as a source of empirical results that they can build upon and extend as part of cumulative science. When these findings don't replicate, the attempts to extend them are a waste of time and resources.  In order to eventually reduce this waste, we need to be able to identify when results can support cumulative scientific progress and what study features are predictive of this. However, limited numbers of replications and limited research into specific predictors of replication failure mean that the reasons for non-replications are not well understood. 
