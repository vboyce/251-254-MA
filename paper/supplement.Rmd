...
```{r forest, out.height="100%", fig.width=9, fig.height=12, fig.pos="ht", fig.cap="TRY FOREST PLOT"}
...
d |> 
  ...
  geom_text(aes(x=-2, label=round(p_orig,3)), size=3, hjust=0, show.legend = F)+
