...
The identification of features that predict replication success is limited by data, however: most analyses use a common dataset of only \textasciitilde170 studies, which vary in how they define replication.

{[}Ben points out that the 170 v 176 doesn't look good -- clarify that 170 isn't per study its \emph{total} / that we are \textasciitilde doubling available{]}
...
\begin{figure}[ht]
\includegraphics[width=1\linewidth,height=0.5\textheight]{manuscript_files/figure-latex/forest-1} \caption{TRY FOREST PLOT}\label{fig:forest}
\end{figure}
