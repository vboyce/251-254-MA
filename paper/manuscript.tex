...
As secondary outcomes, we also calculated prediction intervals following Errington et al. (\protect\hyperlink{ref-errington2021}{2021}) on the key measure of interest from each study. Because of variable statistics and reporting, this was calculable on FOOBAR studies.

\hypertarget{overall-replication-rate}{%
\subsection{Overall replication rate}\label{overall-replication-rate}}

Across the 176 studies, the overall replication rate was 49\% TODO derive in code. FOOBAR \% of the studies had replication outcomes within the prediction interval of the original outcome. The average p\_original value (median?) was TODO.
...
We were interested in determining what the strongest predictors were, which ones are most meaningful, so we threw it all into a big ol regularlized regression model. Despite this, wide uncertainty due to parameterization and stuff. The coefficients see Figure 3 \ldots{} TODO
