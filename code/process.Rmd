...
ggplot(to_plot, aes(x=time, y=value, color=var, label=var))+geom_line()+geom_label_repel(data=to_plot |> filter(time==70), min.segment.length = 100, nudge_x = 15, na.rm = TRUE)+ theme(legend.position="none")+ scale_color_tableau("Classic 20")+
  coord_cartesian(xlim=c(0,90), ylim=c(-.2, .3))+theme(axis.text.x=element_blank(), axis.title.x=element_blank(), axis.ticks.x=element_blank())
...
ggplot(to_plot, aes(x=time, y=value, color=var, label=var))+geom_line()+geom_label_repel(data=to_plot |> filter(time==55), min.segment.length = 100, nudge_x = 15, na.rm = TRUE)+ theme(legend.position="none")+ scale_color_tableau("Classic 20")+
...
ggplot(to_plot, aes(x=time, y=value, color=var, label=var))+geom_line()+geom_label_repel(data=to_plot |> filter(time==69), min.segment.length = 100, nudge_x = 15, na.rm = TRUE)+ theme(legend.position="none")+ scale_color_tableau("Classic 20")+
...
ggplot(to_plot, aes(x=time, y=value, color=var, label=var))+geom_line()+geom_label_repel(data=to_plot |> filter(time==71), min.segment.length = 100, nudge_x = 15, na.rm = TRUE)+ theme(legend.position="none")+ scale_color_tableau("Classic 20")+
  coord_cartesian(xlim=c(0,90))+theme(axis.text.x=element_blank(), axis.title.x=element_blank(), axis.ticks.x=element_blank())
